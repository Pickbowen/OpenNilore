...
extends HudElement {
    public static final class EffectEntry {
        ...
        public final shit.nilore.utils.animation.SmoothAnimationTimer fadeAnim = new shit.nilore.utils.animation.SmoothAnimationTimer();
        public final shit.nilore.utils.animation.SmoothAnimationTimer heightAnim = new shit.nilore.utils.animation.SmoothAnimationTimer();
        public final shit.nilore.utils.animation.SmoothAnimationTimer widthAnim = new shit.nilore.utils.animation.SmoothAnimationTimer();
        ...
        public void show(float targetHeight) {
            this.heightAnim.animate(1.0, 0.3, shit.nilore.utils.math.Easings.EASE_OUT_POW3);
            this.widthAnim.animate(targetHeight, 0.3, shit.nilore.utils.math.Easings.EASE_OUT_POW3);
        }

        public void startRemove() {
            if (this.removing) return;
            this.removing = true;
            this.heightAnim.animate(0.0, 0.2, shit.nilore.utils.math.Easings.EASE_IN_POW3);
            this.widthAnim.animate(0.0, 0.2, shit.nilore.utils.math.Easings.EASE_IN_POW3);
        }
