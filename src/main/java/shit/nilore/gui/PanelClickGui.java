...
import shit.nilore.gui.panel.CategoryBar;
import shit.nilore.gui.panel.KeybindOverlay;
import shit.nilore.gui.panel.ModuleListPanel;
import shit.nilore.gui.panel.ProfileWidget;
import shit.nilore.gui.panel.ScaleSwitchOverlay;
import shit.nilore.gui.panel.SettingsPanel;
import shit.nilore.gui.panel.setting.NumberSettingRenderer;
        ...
        if (this.currentScaleSwitchState == PanelClickGui.OpenState.OPENING) {
            ...
            if (this.openProgress <= 0.0f) {
                ...
                if (NiloreClient.isReady()) {
                    NiloreClient.instance.getConfigManager().saveAll();
                }
