 ...
 * (parent = Forge GameClassLoader) and re-defines every class in nilore.jar onto
 ...
 * {@code INVOKESTATIC shit/nilore/patch/ConnectionPatch.transformReceive}).
 ...
 *       {@code Bootstrap} and {@code NiloreClient} can still find their
...
public final class ModuleInit {
    ...
    public static void load(String jarPath, ClassLoader gameLoader) throws Throwable {
        ...
        // retry in dependency order (a patch class extending a nilore base class
        ...
        Class<?> bootstrapCls = Class.forName("shit.nilore.dll.ClientInit", true, gameLoader);
