...
import shit.lizz.gui.panel.CategoryBar;
import shit.lizz.gui.panel.KeybindOverlay;
import shit.lizz.gui.panel.ModuleListPanel;
import shit.lizz.gui.panel.ProfileWidget;
import shit.lizz.gui.panel.ScaleSwitchOverlay;
import shit.lizz.gui.panel.SettingsPanel;
import shit.lizz.gui.panel.setting.NumberSettingRenderer;
        ...
        if (this.currentScaleSwitchState == PanelClickGui.OpenState.OPENING) {
            ...
            if (this.openProgress <= 0.0f) {
                ...
                if (LizzClient.isReady()) {
                    LizzClient.instance.getConfigManager().saveAll();
                }
