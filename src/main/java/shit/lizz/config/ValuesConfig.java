...
import shit.lizz.config.Config;
...
extends Config {
    ...
    public void read(BufferedReader bufferedReader) throws IOException {
        ...
        while ((string = bufferedReader.readLine()) != null) {
            try {
                ...
                Module module = LizzClient.getInstance().getModuleManager().getModule(string3);
    ...
    public void save(BufferedWriter bufferedWriter) throws IOException {
        for (Module module : LizzClient.getInstance().getModuleManager().getModules()) {
            if (module instanceof HudElement hudElement) {
